...
public class ListAdapter extends ArrayAdapter<JSONObject> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        title.setTypeface(fontPathBoldRale);
        description.setTypeface(fontPathBoldCav);
        price.setTypeface(fontPathBoldCav);

        if(pos == position){
            relLay.setBackgroundTintList(ContextCompat.getColorStateList(context, R.color.listviewtint));
            ...
            relLay.setBackgroundTintList(ContextCompat.getColorStateList(context, R.color.white));
            title.setTextColor(Color.parseColor("#000000"));
            description.setTextColor(Color.parseColor("#000000"));
        }
        try{
